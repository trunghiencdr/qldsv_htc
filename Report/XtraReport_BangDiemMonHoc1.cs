...
{
    public partial class XtraReport_BangDiemMonHoc1 : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReport_BangDiemMonHoc1(String nienkhoa, String hocky, String mamh, String nhom, String magv)
        {
            InitializeComponent();
