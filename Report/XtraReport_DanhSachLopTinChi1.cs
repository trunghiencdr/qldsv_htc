...
{
    public partial class XtraReport_DanhSachLopTinChi1 : DevExpress.XtraReports.UI.XtraReport
    {
        public XtraReport_DanhSachLopTinChi1(String nienkhoa,String hocki,String khoa)
        {
            InitializeComponent();
